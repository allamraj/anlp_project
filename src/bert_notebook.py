...
# model_checkpoint = "xlm-mlm-tlm-xnli15-1024"
...
first_token_id = tokenized_example["input_ids"][0][11]
offsets = tokenized_example["offset_mapping"][0][11]
# print(tokenizer.convert_ids_to_tokens([first_token_id])[0], example["question"])
...
def prepare_train_features(examples):
    ...
    offset_mapping = tokenized_examples.pop("offset_mapping")  # list of 20 tuples (beg,end) if context has 20 words
...
trainer.save_model("content/drive/ANLP/test-squad-trained")
